  ...
  return (
    <div className="mt-4" key={d++}>
      ...
      <p>
        ...
        <a href="https://hr.uiowa.edu/careers/competencies/proficiency-levels" target="_blank" rel="noreferrer">
          here
        </a>. I have a personal Pluralsight license that I use to keep up with any
